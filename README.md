...
`gradle :app:assembleDebug` builds the Android app. For iOS, generate the Xcode project and build with your signing team in Xcode. Device-level gesture and provisioning checks require physical devices. CI runs the Android debug build.
